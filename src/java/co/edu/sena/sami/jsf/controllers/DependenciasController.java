...
import co.edu.sena.sami.jpa.sessions.DependenciasFacade;
...
public class DependenciasController implements Serializable {
    ...
    @EJB
    private co.edu.sena.sami.jpa.sessions.DependenciasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("DependenciasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("DependenciasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("DependenciasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DependenciasControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Dependencias) {
                ...
                return getStringKey(o.getCodigoDeDependencia());
            } else {
