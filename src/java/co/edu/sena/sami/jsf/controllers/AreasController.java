...
public class AreasController implements Serializable {
    ...
    @EJB
    private co.edu.sena.sami.jpa.sessions.AreasFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("AreasCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("AreasUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("AreasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
