...
import co.edu.sena.sami.jpa.entities.Servicios;
import co.edu.sena.sami.jsf.controllers.util.JsfUtil;
import co.edu.sena.sami.jsf.controllers.util.JsfUtil.PersistAction;
import co.edu.sena.sami.jpa.sessions.ServiciosFacade;
...
public class ServiciosController implements Serializable {
    ...
    @EJB
    private co.edu.sena.sami.jpa.sessions.ServiciosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/resources/Bundle").getString("ServiciosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("ServiciosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("ServiciosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
