...
public class CentroFormacionController implements Serializable {
    ...
    public void setSelected(CentroFormacion selected) {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/resources/Bundle").getString("CentroFormacionUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/resources/Bundle").getString("CentroFormacionDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<CentroFormacion> getItems() {
        if (items == null) {
    ...
    public List<CentroFormacion> getItemsAvailableSelectMany() {
        return getFacade().findAll();
    }

    public List<CentroFormacion> getItemsAvailableSelectOne() {
        return getFacade().findAll();
    }
    ...
    public static class CentroFormacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getCentroFormacion(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof CentroFormacion) {
                ...
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), CentroFormacion.class.getName()});
                return null;
            }
        }
